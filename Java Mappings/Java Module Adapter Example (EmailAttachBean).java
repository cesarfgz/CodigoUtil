...
public class EmailAttachBean implements SessionBean, Module {
	...
	public ModuleData process(ModuleContext moduleContext, ModuleData inputModuleData) throws ModuleException {
		...
		try {
			...
			/*
			 * Payload payload = msg.getMainPayload(); payload.setName(fileName);
			 * audit.addAuditLogEntry(key,
			 * AuditLogStatus.SUCCESS,"setting payload as attachment");
			...
			try {
				...
				audit.addAuditLogEntry(key, AuditLogStatus.SUCCESS,
						"Attachment name is successfully changed to : " + attName.getName());
